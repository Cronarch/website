                    ...
                    <div className="relative py-32">
                        ...
                        <div className="relative z-10 mx-auto w-full max-w-5xl px-6">
                            ...
                            <div className="mx-auto max-w-md text-center">
                                <h1 className="text-balance font-serif text-4xl font-medium sm:text-5xl">Save time. Make money.</h1>
                                <p className="text-muted-foreground mt-4 text-balance">Cronarch is your all-in-one platform for automating your business.</p>
